 ...
 * @author Slide Gurtiza
 */
class Messerve_Model_Staff extends Messerve_Model_ModelAbstract
{
    ...
    /**
     * Database var type enum('mechanic','stockman','accounting','manager','admin')
     *
     * @var string
     */
    protected $_Type;
     ...
     *
     * @return Messerve_Model_Mapper_Staff
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new Messerve_Model_Mapper_Staff());
        }
     ...
     *
	 * @see Messerve_Model_Mapper_Staff::delete
