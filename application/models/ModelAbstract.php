 ...
 * @author Slide Gurtiza
 */
abstract class Messerve_Model_ModelAbstract
{
    /**
     * Mapper associated with this model instance
     *
     * @var Messerve_Model_ModelAbstract
     */
    protected $_mapper;
     ...
     *
     * @param array $data
     * @return Messerve_Model_ModelAbstract
     */
     ...
     *
     * @see Messerve_Model_DbTable_TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see Messerve_Model_Mapper_MapperAbstract::toArray()
     * @return array
     */
     ...
     *
     * @param Messerve_Model_Mapper_MapperAbstract $mapper
     * @return Messerve_Model_ModelAbstract
     */
     ...
     *
     * @see Messerve_Model_Mapper_MapperAbstract::save()
     ...
     *
     * @param Messerve_Model_ModelAbstract $model Object to be compared to
     ...
     */
/*    public function diff(Messerve_Model_ModelAbstract $model,
     $ignorePrimaryKey = true, $relations = false, $load = true
        ...
        if ($relations) {
        	...
        	foreach($all_relations as $key => $property) {
        		...
        		if (is_null($value)) {
        			continue;
        		} elseif ($value instanceof Messerve_Model_ModelAbstract)  {
        			...
        			foreach ($value as $val) {
        				if ($val instanceof Messerve_Model_ModelAbstract) {
        		...
        		if (method_exists($model, $method)) {
        			...
        			if (is_null($other_value)) {
        				$other_value = array();
        			} elseif ($other_value instanceof Messerve_Model_ModelAbstract) {
