 ...
 * @author Slide Gurtiza
 */
class Messerve_Model_RateBak extends Messerve_Model_ModelAbstract
{
     ...
     *
     * @return Messerve_Model_Mapper_RateBak
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new Messerve_Model_Mapper_RateBak());
        }
     ...
     *
	 * @see Messerve_Model_Mapper_RateBak::delete
