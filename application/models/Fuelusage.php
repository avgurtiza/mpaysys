 ...
 * @author Slide Gurtiza
 */
class Messerve_Model_Fuelusage extends Messerve_Model_ModelAbstract
{
     ...
     *
     * @param int $data
     * @return Messerve_Model_Fuelusage
     */
     ...
     *
     * @return Messerve_Model_Mapper_Fuelusage
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new Messerve_Model_Mapper_Fuelusage());
        }
     ...
     *
	 * @see Messerve_Model_Mapper_Fuelusage::delete
