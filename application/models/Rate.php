 ...
 * @author Slide Gurtiza
 */
class Messerve_Model_Rate extends Messerve_Model_ModelAbstract
{
    ...
    /**
     * Database var type decimal(10,3)
     *
     * @var float
     */
    protected $_Reg;
     ...
     *
     * @return Messerve_Model_Mapper_Rate
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new Messerve_Model_Mapper_Rate());
        }
     ...
     *
	 * @see Messerve_Model_Mapper_Rate::delete
