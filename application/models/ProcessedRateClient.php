 ...
 * @author Slide Gurtiza
 */
class Messerve_Model_ProcessedRateClient extends Messerve_Model_ModelAbstract
{
     ...
     *
     * @param int $data
     * @return Messerve_Model_ProcessedRateClient
     */
     ...
     *
     * @return Messerve_Model_Mapper_ProcessedRateClient
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new Messerve_Model_Mapper_ProcessedRateClient());
        }
     ...
     *
	 * @see Messerve_Model_Mapper_ProcessedRateClient::delete
