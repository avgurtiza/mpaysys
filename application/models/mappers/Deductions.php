...
/**
 * Data Mapper implementation for Messerve_Model_Deductions
 *
 * @package Messerve_Model
 * @subpackage Mapper
 * @author Slide Gurtiza
 */
class Messerve_Model_Mapper_Deductions extends Messerve_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Messerve_Model_Deductions $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Messerve_Model_Deductions) {
        ...
        $result = array(
            ...
            'maintenance_deduct' => $model->getMaintenanceDeduct(),
     ...
     *
     * @return Messerve_Model_DbTable_Deductions
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Messerve_Model_DbTable_Deductions');
        }
     ...
     *
     * @param Messerve_Model_Deductions $model The model to delete
     ...
     */
    public function save(Messerve_Model_Deductions $model,
     ...
     * @param Messerve_Model_Deductions|null $model
     * @return Messerve_Model_Deductions|null The object provided or null if not found
     */
     ...
     * @param Messerve_Model_Deductions|null $entry The object to load the data into, or null to have one created
     * @return Messerve_Model_Deductions The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Messerve_Model_Deductions();
        }
        ...
        if (is_array($data)) {
            $entry->setId($data['id'])
                  ...
                  ->setMaintenanceDeduct($data['maintenance_deduct'])
