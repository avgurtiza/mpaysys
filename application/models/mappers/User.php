...
/**
 * Data Mapper implementation for Messerve_Model_User
 *
 * @package Messerve_Model
 * @subpackage Mapper
 * @author Slide Gurtiza
 */
class Messerve_Model_Mapper_User extends Messerve_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Messerve_Model_User $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Messerve_Model_User) {
     ...
     *
     * @return Messerve_Model_DbTable_User
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Messerve_Model_DbTable_User');
        }
     ...
     *
     * @param Messerve_Model_User $model The model to delete
     ...
     */
    public function save(Messerve_Model_User $model,
     ...
     * @param Messerve_Model_User|null $model
     * @return Messerve_Model_User|null The object provided or null if not found
     */
     ...
     * @param Messerve_Model_User|null $entry The object to load the data into, or null to have one created
     * @return Messerve_Model_User The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Messerve_Model_User();
        }
