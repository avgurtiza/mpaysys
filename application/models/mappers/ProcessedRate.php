...
/**
 * Data Mapper implementation for Messerve_Model_ProcessedRate
 *
 * @package Messerve_Model
 * @subpackage Mapper
 * @author Slide Gurtiza
 */
class Messerve_Model_Mapper_ProcessedRate extends Messerve_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Messerve_Model_ProcessedRate $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Messerve_Model_ProcessedRate) {
     ...
     *
     * @return Messerve_Model_DbTable_ProcessedRate
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Messerve_Model_DbTable_ProcessedRate');
        }
     ...
     *
     * @param Messerve_Model_ProcessedRate $model The model to delete
     ...
     */
    public function save(Messerve_Model_ProcessedRate $model,
     ...
     * @param Messerve_Model_ProcessedRate|null $model
     * @return Messerve_Model_ProcessedRate|null The object provided or null if not found
     */
     ...
     * @param Messerve_Model_ProcessedRate|null $entry The object to load the data into, or null to have one created
     * @return Messerve_Model_ProcessedRate The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Messerve_Model_ProcessedRate();
        }
