 ...
 * @author Slide Gurtiza
 */
abstract class Messerve_Model_Mapper_MapperAbstract
{
    /**
     * $_dbTable - instance of Messerve_Model_DbTable_TableAbstract
     *
     * @var Messerve_Model_DbTable_TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Messerve_Model_DbTable_TableAbstract $dbTable
     * @return Messerve_Model_Mapper_MapperAbstract
     */
     ...
     * @param Messerve_Model_ModelAbstract $model
    ...
    public function loadRelated($name, $model)
    {
        ...
        $obj = $row->$method('Messerve_Model_DbTable_' . $object_table_name, $rule);

        if (! empty($obj)) {
            $model_class = 'Messerve_Model_' . $object_table_name;
     ...
     *
     * @see Messerve_Model_DbTable_TableAbstract::countAllRows()
     ...
     *
     * @see Messerve_Model_DbTable_TableAbstract::countByQuery()
     ...
     *
     * @param Messerve_Model_ModelAbstract $model The model to delete
     * @return int
     */
    ...
    {
        $adapter = new Messerve_Model_Paginator($select, $this);
     ...
     * @return array All Messerve_Model_ModelAbstract meeting the criteria
     */
     ...
     * @param Messerve_Model_ModelAbstract|null $model
     * @return Messerve_Model_ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Messerve_Model_DbTable_TableAbstract
     */
     ...
     *
     * @param new Messerve_Model_ModelAbstract $model
     * @return array
     */
     ...
     * @param Messerve_Model_ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
