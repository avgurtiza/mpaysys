...
/**
 * Data Mapper implementation for Messerve_Model_RateClient
 *
 * @package Messerve_Model
 * @subpackage Mapper
 * @author Slide Gurtiza
 */
class Messerve_Model_Mapper_RateClient extends Messerve_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Messerve_Model_RateClient $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Messerve_Model_RateClient) {
     ...
     *
     * @return Messerve_Model_DbTable_RateClient
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Messerve_Model_DbTable_RateClient');
        }
     ...
     *
     * @param Messerve_Model_RateClient $model The model to delete
     ...
     */
    public function save(Messerve_Model_RateClient $model,
     ...
     * @param Messerve_Model_RateClient|null $model
     * @return Messerve_Model_RateClient|null The object provided or null if not found
     */
     ...
     * @param Messerve_Model_RateClient|null $entry The object to load the data into, or null to have one created
     * @return Messerve_Model_RateClient The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Messerve_Model_RateClient();
        }
